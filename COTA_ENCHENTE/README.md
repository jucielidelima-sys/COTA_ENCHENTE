...
## Base de dados
O arquivo Excel já está dentro da pasta `base/COTA_ENCHENTE.xlsx`. Não há botão de upload no dashboard; para atualizar a base, substitua esse arquivo mantendo o mesmo nome.
